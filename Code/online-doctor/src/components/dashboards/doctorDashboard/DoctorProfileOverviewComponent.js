...
export default function DoctorProfileOverviewComponent() {
    ...
    return (
        <div className="tab-pane fade show active profile-overview" id="profile-overview">
            ...
            <div className="row">
                <div className="col-lg-3 col-md-4 label">Doctor Registration Number</div>
                <div className="col-lg-9 col-md-8">{userInfo.doctorRegNumber}</div>
            </div>

            <div className="row">
                <div className="col-lg-3 col-md-4 label">Specialization</div>
                <div className="col-lg-9 col-md-8">{userInfo.specialization}</div>
            </div>
