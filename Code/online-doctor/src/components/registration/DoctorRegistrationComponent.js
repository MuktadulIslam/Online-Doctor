...
export default function DoctorRegistrationComponent() {
     ...
     const register = (event) => {
          ...
          formData.append('doctorRegNumber', doctorRegNumber);
          formData.append('doctorDegree', doctorDegree);
          formData.append('specialization', specialization);
          formData.append('username', username);
          formData.append('password', password);

          Axios.post(Constants.SERVER_IP + "doctorRegister", formData).then((response) => {
     ...
     <div className="container">
          ...
          <form id = "regForm" className="row g-3 needs-validation" onSubmit={register}>
               ...
               <div className="col-md-6">
                    ...
                    <input required type="file" name="photo" className="form-control" id="photo" onChange={(e) => {setPhoto(e.target.files[0]);setShowPopupComponent(false);}}/>
               </div>
               <div className="col-md-6">
               ...
               <div className="col-md-6">
                    ...
                    <input required type="file" name="degree" className="form-control" id="degree" onChange={(e) => {setDoctorDegree(e.target.files[0]);setShowPopupComponent(false);}} />
               </div>
